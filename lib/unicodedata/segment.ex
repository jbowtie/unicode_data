defmodule UnicodeData.Segment do
  ...
  def uax14_required_rules(left, right) do
    case {left, right} do
      ...
      {x, "CM"} when x not in ["BK", "CR", "LF", "NL", "SP", "ZW"] ->
        :prohibited

      {x, "ZWJ"} when x not in ["BK", "CR", "LF", "NL", "SP", "ZW"] ->
        :prohibited
  ...
  @uax14_default_rules [
    &UnicodeData.Segment.uax14_12a/2,
    &UnicodeData.Segment.uax14_13/2,
    &UnicodeData.Segment.uax14_14/2,
    &UnicodeData.Segment.uax14_15/2,
    &UnicodeData.Segment.uax14_16/2,
    &UnicodeData.Segment.uax14_17/2,
    &UnicodeData.Segment.uax14_18/2,
    &UnicodeData.Segment.uax14_19/2,
    &UnicodeData.Segment.uax14_20/2,
    &UnicodeData.Segment.uax14_21/2,
    &UnicodeData.Segment.uax14_21b/2,
    &UnicodeData.Segment.uax14_22/2,
    &UnicodeData.Segment.uax14_23/2,
    &UnicodeData.Segment.uax14_24/2,
    &UnicodeData.Segment.uax14_25/2,
    &UnicodeData.Segment.uax14_26/2,
    &UnicodeData.Segment.uax14_27/2,
    &UnicodeData.Segment.uax14_28/2,
    &UnicodeData.Segment.uax14_29/2,
    &UnicodeData.Segment.uax14_30/2
  ]
  ...
  defp uax14_space_state([x1, "SP"], carry_fwd, _)
       when x1 in ["CM", "ZWJ"] and carry_fwd in ["OP", "QU", "CL", "CP", "B2", "ZW"] do
    # automatically prohibit (LB 7)
  ...
  defp uax14_space_state([x, "CM"], _, rules)
       when x not in ["SP", "BK", "CR", "LF", "NL", "ZW", "CM", "ZWJ"] do
    # but also carry foward for other rules
    {line_break_between(x, "CM", rules), x}
  end

  defp uax14_space_state([x, "ZWJ"], _, rules)
       when x not in ["SP", "BK", "CR", "LF", "NL", "ZW", "CM", "ZWJ"] do
    # automatically prohibit (LB 7)
    # but also carry foward for other rules
    {line_break_between(x, "CM", rules), x}
  ...
  lines =
    File.stream!(wordbreak_path, [], :line)
    |> Stream.filter(&String.match?(&1, ~r/^[0-9A-F]+/))
  ...
  lines =
    File.stream!(sentence_path, [], :line)
    |> Stream.filter(&String.match?(&1, ~r/^[0-9A-F]+/))
